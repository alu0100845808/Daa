...
public class Instancia {
        ...
        public Instancia(Instancia instancia){
            numeroTareas = new Integer(instancia.getNumeroTareas());
            numeroMaquinas = new Integer(instancia.getNumeroMaquinas());
            tareas = new ArrayList<Tarea>();
            for (int i = 0; i < instancia.getTareas().size(); i++) {
				tareas.add(new Tarea(instancia.getTareas().get(i)));
			}
            tPreparacion = instancia.getTPreparacion();
        }
